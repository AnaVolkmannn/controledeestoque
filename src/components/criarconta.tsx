  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Texto e imagem*/}
        <div className="flex">
          <div>
              <img src="img-criarconta.png" alt="Imagem tela de entrada" className="w-170" />
            </div>
          <h2 className="text-4xl font-extrabold mb-4 text-center text-orange-950">Criar uma conta</h2>
        </div>
